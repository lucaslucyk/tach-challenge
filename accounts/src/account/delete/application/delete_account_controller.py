...
from accounts.src.account.delete.application.account_deleter import (
    AccountDeleter,
)
...
class DeleteAccountController(AsyncSanicController):
    ...
    async def execute(self, aggregate_id: Uuid) -> Result[Account, Error]:
        ...
        return await account_deleter.execute(aggregate_id)
