...
if is_sanic_available():
    ...
    from petisco_sanic.extra.sanic.application.response_mocker import ResponseMocker
    from petisco_sanic.extra.sanic.controller.as_sanic import as_sanic
    from petisco_sanic.extra.sanic.controller.sanic_controller import SanicController
